...
class CandlestickChart extends React.Component {
  ...
  render() {
    ...
    const ohlc = ['high', 'low', 'open', 'close'];
    ...
    return (
      ...
      >
        <Chart
          id={1}
          yExtents={d => yExtents(d, ohlc, yMax, yMin)}
        >
          ...
          <HoverTooltip
            yAccessor={d => d[ohlc[0]]}
            tooltipContent={tooltipContent(ohlc)}
            fontSize={15}
          />
          {/* <CandlestickSeries fill={d => d.close > d.open ? "rgba(196, 205, 211, 0.8)" : "rgba(22, 22, 22, 0.8)"} stroke={'#00ff00'} /> */}
          <CandlestickSeries />
        </Chart>
        <CrossHairCursor />
      </ChartCanvas>
